...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,861 | 🐛 2,750 | 🌐 C++ | 📅 2026-09-16 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,590 | 🐛 952 | 🌐 Python | 📅 2026-09-16 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,760 | 🐛 1,247 | 🌐 Python | 📅 2026-09-16 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,628 | 🐛 656 | 🌐 C++ | 📅 2026-09-15 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,137 | 🐛 306 | 🌐 Python | 📅 2026-09-15 - Open-source software helping biologists turn images into cell measurements.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 201 | 🐛 61 | 🌐 Python | 📅 2026-09-16 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,364 | 🐛 68 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [CellVit++](https://github.com/TIO-IKIM/CellViT) ⭐ 396 | 🐛 21 | 🌐 Python | 📅 2025-07-23 - A framework for lightweight cell segmentation model training and inference.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 37 | 🐛 23 | 🌐 Python | 📅 2026-09-14 - A GUI and a library for segmentation algorithms.
...
* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,485 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-05 - WebGL-based viewer for volumetric data.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 670 | 🐛 10 | 🌐 Python | 📅 2026-09-08 - Python package for the visualization of three dimensional neuro-anatomical data.
...
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 186 | 🐛 293 | 🌐 Python | 📅 2026-09-15 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 128 | 🐛 59 | 🌐 Python | 📅 2026-09-10 - Segment axon and myelin from microscopy data using deep learning.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 824 | 🐛 77 | 🌐 Python | 📅 2026-09-16 - Open-source image analysis software package targeted for plant phenotyping.
...
* [Spotiflow](https://github.com/weigertlab/spotiflow) ⭐ 142 | 🐛 7 | 🌐 Python | 📅 2026-06-08 - A deep learning-based, threshold-agnostic, and subpixel-accurate spot detection method developed for spatial transcriptomics workflows.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,085 | 🐛 101 | 🌐 C++ | 📅 2026-09-16 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
* [ZeroCostDL4Mic](https://github.com/HenriquesLab/ZeroCostDL4Mic) ⭐ 650 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Google Colab to develop a free and open-source toolbox for deep-Learning in microscopy.
* [Neurite](https://github.com/adalca/neurite) ⭐ 376 | 🐛 20 | 🌐 Python | 📅 2026-09-15 - Neural networks toolbox focused on medical image analysis.
...
* [Cytodata](https://github.com/cytodata/awesome-cytodata) ⭐ 95 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-15 - A curated list of awesome cytodata resources.
