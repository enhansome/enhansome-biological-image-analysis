...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,488 | 🐛 2,741 | 🌐 C++ | 📅 2026-08-18 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,572 | 🐛 939 | 🌐 Python | 📅 2026-08-17 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,735 | 🐛 1,237 | 🌐 Python | 📅 2026-08-18 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,581 | 🐛 663 | 🌐 C++ | 📅 2026-08-18 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 64 | 🌐 Python | 📅 2026-08-18 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,314 | 🐛 66 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 712 | 🐛 75 | 🌐 Jupyter Notebook | 📅 2026-08-18 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 588 | 🐛 97 | 🌐 Python | 📅 2026-08-18 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 184 | 🐛 290 | 🌐 Python | 📅 2026-08-18 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [TrackMate](https://github.com/fiji/TrackMate) ⭐ 238 | 🐛 22 | 🌐 Java | 📅 2026-08-18 - User-friendly interface that allows for performing tracking, data visualization, editing results and track analysis in a convenient way.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,082 | 🐛 96 | 🌐 C++ | 📅 2026-08-18 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
