...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,678 | 🐛 2,756 | 🌐 C++ | 📅 2026-09-01 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,579 | 🐛 950 | 🌐 Python | 📅 2026-09-01 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,752 | 🐛 1,233 | 🌐 Python | 📅 2026-09-01 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,607 | 🐛 665 | 🌐 C++ | 📅 2026-09-01 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 64 | 🌐 Python | 📅 2026-09-01 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 716 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2026-09-01 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 596 | 🐛 99 | 🌐 Python | 📅 2026-08-31 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Proseg](https://github.com/dcjones/proseg) ⭐ 187 | 🐛 82 | 🌐 Rust | 📅 2026-09-01 : A cell segmentation method for in situ spatial transcriptomics.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 668 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - Python package for the visualization of three dimensional neuro-anatomical data.
...
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 185 | 🐛 291 | 🌐 Python | 📅 2026-08-31 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 150 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Automated 3D brain registration with support for multiple species and atlases.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 61 | 🐛 11 | 🌐 Java | 📅 2026-08-31 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 820 | 🐛 135 | 🌐 Python | 📅 2026-09-01 - Open-source image analysis software package targeted for plant phenotyping.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,083 | 🐛 101 | 🌐 C++ | 📅 2026-09-01 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [Pycytominer](https://github.com/cytomining/pycytominer) ⭐ 144 | 🐛 45 | 🌐 Python | 📅 2026-09-01 - Data processing functions for profiling perturbations.
