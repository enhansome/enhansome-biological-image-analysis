...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,714 | 🐛 2,768 | 🌐 C++ | 📅 2026-09-04 - Open source computer vision and machine learning software library.
...
* [Napari](https://github.com/napari/napari) ⭐ 2,755 | 🐛 1,238 | 🌐 Python | 📅 2026-09-04 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,612 | 🐛 666 | 🌐 C++ | 📅 2026-09-02 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,340 | 🐛 66 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 717 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-09-04 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 595 | 🐛 102 | 🌐 Python | 📅 2026-09-03 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Proseg](https://github.com/dcjones/proseg) ⭐ 188 | 🐛 81 | 🌐 Rust | 📅 2026-09-04 : A cell segmentation method for in situ spatial transcriptomics.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 668 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - Python package for the visualization of three dimensional neuro-anatomical data.
