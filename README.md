...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,663 | 🐛 2,754 | 🌐 C++ | 📅 2026-08-31 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,580 | 🐛 953 | 🌐 Python | 📅 2026-08-26 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,751 | 🐛 1,235 | 🌐 Python | 📅 2026-08-31 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,605 | 🐛 665 | 🌐 C++ | 📅 2026-08-31 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,401 | 🐛 134 | 🌐 Java | 📅 2026-08-07 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,135 | 🐛 306 | 🌐 Python | 📅 2026-08-31 - Open-source software helping biologists turn images into cell measurements.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 67 | 🌐 Python | 📅 2026-08-27 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,334 | 🐛 67 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 716 | 🐛 70 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 596 | 🐛 98 | 🌐 Python | 📅 2026-08-31 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 469 | 🐛 58 | 🌐 Python | 📅 2026-08-23 - Pipeline for processing two-photon calcium imaging data.
...
* [Proseg](https://github.com/dcjones/proseg) ⭐ 187 | 🐛 82 | 🌐 Rust | 📅 2026-08-28 : A cell segmentation method for in situ spatial transcriptomics.
...
* [SyMBac](https://github.com/georgeoshardo/SyMBac) ⭐ 23 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2026-08-07 - Accurate segmentation of bacterial microscope images using synthetically generated image data.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 667 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - Python package for the visualization of three dimensional neuro-anatomical data.
...
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 185 | 🐛 288 | 🌐 Python | 📅 2026-08-31 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 150 | 🐛 20 | 🌐 Python | 📅 2026-08-28 - Automated 3D brain registration with support for multiple species and atlases.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 820 | 🐛 135 | 🌐 Python | 📅 2026-08-25 - Open-source image analysis software package targeted for plant phenotyping.
...
* [Picasso](https://github.com/jungmannlab/picasso) ⭐ 147 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - A collection of tools for painting super-resolution images.
...
* [SMAP](https://github.com/jries/SMAP) ⭐ 84 | 🐛 12 | 🌐 MATLAB | 📅 2026-08-30 - A modular super-resolution microscopy analysis platform for SMLM data.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,083 | 🐛 98 | 🌐 C++ | 📅 2026-08-31 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [OAD](https://github.com/zeiss-microscopy/OAD) ⭐ 172 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-07-10 - Collection of tools and scripts useful to automate microscopy workflows in ZEN Blue using Python and Open Application Development tools.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-08-31 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
