...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,850 | 🐛 2,759 | 🌐 C++ | 📅 2026-09-15 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,589 | 🐛 951 | 🌐 Python | 📅 2026-09-09 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,759 | 🐛 1,251 | 🌐 Python | 📅 2026-09-15 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,627 | 🐛 656 | 🌐 C++ | 📅 2026-09-15 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 201 | 🐛 59 | 🌐 Python | 📅 2026-09-15 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,361 | 🐛 68 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 721 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
...
* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,467 | 🐛 238 | 🌐 TypeScript | 📅 2026-09-05 - WebGL-based viewer for volumetric data.
...
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 130 | 🐛 19 | 🌐 Python | 📅 2026-09-15 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,084 | 🐛 99 | 🌐 C++ | 📅 2026-09-15 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
