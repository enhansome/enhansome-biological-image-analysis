...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,788 | 🐛 2,771 | 🌐 C++ | 📅 2026-09-10 - Open source computer vision and machine learning software library.
...
* [Napari](https://github.com/napari/napari) ⭐ 2,757 | 🐛 1,247 | 🌐 Python | 📅 2026-09-07 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,624 | 🐛 656 | 🌐 C++ | 📅 2026-09-10 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 62 | 🌐 Python | 📅 2026-09-10 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,354 | 🐛 68 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 720 | 🐛 73 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
...
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 231 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - Automated 3D cell detection and registration of whole-brain images.
...
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 186 | 🐛 295 | 🌐 Python | 📅 2026-09-10 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 150 | 🐛 20 | 🌐 Python | 📅 2026-09-10 - Automated 3D brain registration with support for multiple species and atlases.
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 127 | 🐛 60 | 🌐 Python | 📅 2026-09-10 - Segment axon and myelin from microscopy data using deep learning.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 822 | 🐛 78 | 🌐 Python | 📅 2026-09-10 - Open-source image analysis software package targeted for plant phenotyping.
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 130 | 🐛 25 | 🌐 Python | 📅 2026-09-10 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,085 | 🐛 103 | 🌐 C++ | 📅 2026-09-10 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-09-10 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
