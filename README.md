...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,628 | 🐛 2,751 | 🌐 C++ | 📅 2026-08-27 - Open source computer vision and machine learning software library.
...
* [Napari](https://github.com/napari/napari) ⭐ 2,744 | 🐛 1,241 | 🌐 Python | 📅 2026-08-25 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,596 | 🐛 666 | 🌐 C++ | 📅 2026-08-26 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,135 | 🐛 306 | 🌐 Python | 📅 2026-08-27 - Open-source software helping biologists turn images into cell measurements.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 715 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 595 | 🐛 95 | 🌐 Python | 📅 2026-08-27 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 666 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - Python package for the visualization of three dimensional neuro-anatomical data.
...
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 149 | 🐛 21 | 🌐 Python | 📅 2026-08-27 - Automated 3D brain registration with support for multiple species and atlases.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 817 | 🐛 134 | 🌐 Python | 📅 2026-08-25 - Open-source image analysis software package targeted for plant phenotyping.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,082 | 🐛 103 | 🌐 C++ | 📅 2026-08-27 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-08-27 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
