...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,757 | 🐛 2,778 | 🌐 C++ | 📅 2026-09-08 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,582 | 🐛 947 | 🌐 Python | 📅 2026-09-04 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,757 | 🐛 1,243 | 🌐 Python | 📅 2026-09-07 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,619 | 🐛 658 | 🌐 C++ | 📅 2026-09-08 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Ilastik](https://github.com/ilastik/ilastik) ⭐ 407 | 🐛 571 | 🌐 Python | 📅 2026-08-27 - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 63 | 🌐 Python | 📅 2026-09-08 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,352 | 🐛 66 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 720 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-09-08 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 596 | 🐛 102 | 🌐 Python | 📅 2026-09-08 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 472 | 🐛 64 | 🌐 Python | 📅 2026-09-07 - Pipeline for processing two-photon calcium imaging data.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 37 | 🐛 20 | 🌐 Python | 📅 2026-09-08 - A GUI and a library for segmentation algorithms.
...
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 186 | 🐛 298 | 🌐 Python | 📅 2026-09-08 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 127 | 🐛 59 | 🌐 Python | 📅 2026-09-08 - Segment axon and myelin from microscopy data using deep learning.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 61 | 🐛 12 | 🌐 Java | 📅 2026-09-08 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 822 | 🐛 123 | 🌐 Python | 📅 2026-09-08 - Open-source image analysis software package targeted for plant phenotyping.
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 130 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,085 | 🐛 102 | 🌐 C++ | 📅 2026-09-06 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
