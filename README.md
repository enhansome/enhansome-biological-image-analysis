...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,949 | 🐛 2,774 | 🌐 C++ | 📅 2026-09-23 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 952 | 🌐 Python | 📅 2026-09-23 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,762 | 🐛 1,257 | 🌐 Python | 📅 2026-09-23 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,636 | 🐛 637 | 🌐 C++ | 📅 2026-09-23 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 202 | 🐛 64 | 🌐 Python | 📅 2026-09-23 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,375 | 🐛 68 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 724 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
...
* [CellVit++](https://github.com/TIO-IKIM/CellViT) ⭐ 398 | 🐛 21 | 🌐 Python | 📅 2025-07-23 - A framework for lightweight cell segmentation model training and inference.
...
* [CellSAM](https://github.com/vanvalenlab/cellSAM) ⭐ 219 | 🐛 51 | 🌐 Python | 📅 2026-06-04 - A foundation model for cell segmentation trained on a diverse range of cells and data types.
* [Proseg](https://github.com/dcjones/proseg) ⭐ 191 | 🐛 84 | 🌐 Rust | 📅 2026-09-22 : A cell segmentation method for in situ spatial transcriptomics.
...
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 201 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 187 | 🐛 296 | 🌐 Python | 📅 2026-09-23 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 61 | 🐛 12 | 🌐 Java | 📅 2026-09-23 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 829 | 🐛 73 | 🌐 Python | 📅 2026-09-22 - Open-source image analysis software package targeted for plant phenotyping.
...
* [MIA](https://github.com/mianalysis/mia) ⭐ 17 | 🐛 45 | 🌐 Java | 📅 2026-09-23 - Fiji plugin which provides a modular framework for assembling image and object analysis workflows.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-09-23 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
