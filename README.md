# Awesome Biological Image Analysis with stars
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,415 | 🐛 2,750 | 🌐 C++ | 📅 2026-08-13 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,573 | 🐛 939 | 🌐 Python | 📅 2026-08-04 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,731 | 🐛 1,230 | 🌐 Python | 📅 2026-08-13 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,578 | 🐛 660 | 🌐 C++ | 📅 2026-08-12 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,393 | 🐛 134 | 🌐 Java | 📅 2026-08-07 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,130 | 🐛 308 | 🌐 Python | 📅 2026-08-12 - Open-source software helping biologists turn images into cell measurements.
* [Fiji](https://github.com/fiji/fiji) ⭐ 1,007 | 🐛 138 | 🌐 Shell | 📅 2026-07-18 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
* [ImageJ](https://github.com/imagej/ImageJ) ⭐ 780 | 🐛 88 | 🌐 Java | 📅 2026-07-22 - Public domain software for processing and analyzing scientific images.
* [Ilastik](https://github.com/ilastik/ilastik) ⭐ 405 | 🐛 569 | 🌐 Python | 📅 2026-08-07 - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 61 | 🌐 Python | 📅 2026-08-13 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [PYME](https://github.com/python-microscopy/python-microscopy) ⭐ 99 | 🐛 146 | 🌐 Python | 📅 2026-08-13 - Open-source application suite for light microscopy acquisition, data storage, visualization, and analysis.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,308 | 🐛 66 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
* [StarDist](https://github.com/stardist/stardist) ⭐ 1,251 | 🐛 69 | 🌐 Python | 📅 2026-02-14 - Object detection with Star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net) ⭐ 735 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - A multi-branch network for nuclear instance segmentation and classification with pre-trained weights.
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 709 | 🐛 75 | 🌐 Jupyter Notebook | 📅 2026-08-13 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 589 | 🐛 96 | 🌐 Python | 📅 2026-08-13 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [DeepCell](https://github.com/vanvalenlab/deepcell-tf) ⭐ 477 | 🐛 56 | 🌐 Python | 📅 2026-06-04 - Deep learning library for single cell analysis.
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 467 | 🐛 58 | 🌐 Python | 📅 2026-08-10 - Pipeline for processing two-photon calcium imaging data.
* [CellVit++](https://github.com/TIO-IKIM/CellViT) ⭐ 392 | 🐛 21 | 🌐 Python | 📅 2025-07-23 - A framework for lightweight cell segmentation model training and inference.
...
* [CellSAM](https://github.com/vanvalenlab/cellSAM) ⭐ 209 | 🐛 49 | 🌐 Python | 📅 2026-06-04 - A foundation model for cell segmentation trained on a diverse range of cells and data types.
* [Proseg](https://github.com/dcjones/proseg) ⭐ 183 | 🐛 81 | 🌐 Rust | 📅 2026-08-10 : A cell segmentation method for in situ spatial transcriptomics.
...
* [MorpholibJ](https://github.com/ijpb/MorphoLibJ) ⭐ 124 | 🐛 24 | 🌐 Java | 📅 2026-07-30 - Collection of mathematical morphology methods and plugins for ImageJ.
...
* [Nellie](https://github.com/aelefebv/nellie) ⭐ 99 | 🐛 4 | 🌐 Python | 📅 2026-05-15 - Automated organelle segmentation, tracking, and hierarchical feature extraction in 2D/3D live-cell microscopy.
...
* [MAPS](https://github.com/mahmoodlab/MAPS) ⭐ 68 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-03-14 - MAPS (Machine learning for Analysis of Proteomics in Spatial biology) is a machine learning approach facilitating rapid and precise cell type identification with human-level accuracy from spatial proteomics data.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 37 | 🐛 25 | 🌐 Python | 📅 2026-08-13 - A GUI and a library for segmentation algorithms.
* [Classpose](https://github.com/sohmandal/classpose) ⭐ 33 | 🐛 3 | 🌐 Python | 📅 2026-07-28 - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
* [SyMBac](https://github.com/georgeoshardo/SyMBac) ⭐ 23 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2026-08-07 - Accurate segmentation of bacterial microscope images using synthetically generated image data.
...
* [ThermImageJ](https://github.com/gtatters/ThermImageJ) ⭐ 55 | 🐛 0 | 🌐 ImageJ Macro | 📅 2026-06-27 - ImageJ functions and macros for working with thermal image files.

## Neuroscience

* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,348 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-13 - WebGL-based viewer for volumetric data.
* [CaImAn](https://github.com/flatironinstitute/CaImAn) ⭐ 728 | 🐛 101 | 🌐 Python | 📅 2026-08-02 - Computational toolbox for large scale Calcium Imaging Analysis.
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 666 | 🐛 9 | 🌐 Python | 📅 2026-08-10 - Python package for the visualization of three dimensional neuro-anatomical data.
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 231 | 🐛 89 | 🌐 Python | 📅 2026-08-11 - Automated 3D cell detection and registration of whole-brain images.
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 183 | 🐛 284 | 🌐 Python | 📅 2026-08-13 - A lightweight Python module to interact with atlases for systems neuroscience.
* [CloudVolume](https://github.com/seung-lab/cloud-volume) ⭐ 175 | 🐛 92 | 🌐 Python | 📅 2026-08-13 - Read and write Neuroglancer datasets programmatically.
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 149 | 🐛 19 | 🌐 Python | 📅 2026-08-04 - Automated 3D brain registration with support for multiple species and atlases.
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 127 | 🐛 55 | 🌐 Python | 📅 2026-08-12 - Segment axon and myelin from microscopy data using deep learning.
* [Wholebrain](https://github.com/tractatus/wholebrain) ⭐ 92 | 🐛 29 | 🌐 C++ | 📅 2021-07-16 - Automated cell detection and registration of whole-brain images with plot of cell counts per region and Hemishpere.
* [NeuroAnatomy Toolbox](https://github.com/natverse/nat) ⭐ 78 | 🐛 57 | 🌐 R | 📅 2026-07-30 - R package for the (3D) visualisation and analysis of biological image data, especially tracings of single neurons.
* [SNT](https://github.com/morphonets/SNT/) ⭐ 60 | 🐛 11 | 🌐 Java | 📅 2026-08-13 - ImageJ framework for semi-automated tracing and analysis of neurons.
* [TrailMap](https://github.com/AlbertPun/TRAILMAP/) ⭐ 46 | 🐛 6 | 🌐 Python | 📅 2026-06-18 - Software package to extract axonal data from cleared brains.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 814 | 🐛 130 | 🌐 Python | 📅 2026-08-12 - Open-source image analysis software package targeted for plant phenotyping.
...
* [RootPainter](https://github.com/Abe404/root_painter) ⭐ 81 | 🐛 40 | 🌐 Python | 📅 2026-07-03 - Deep learning segmentation of biological images with corrective annotation.
...
* [Spotiflow](https://github.com/weigertlab/spotiflow) ⭐ 139 | 🐛 6 | 🌐 Python | 📅 2026-06-08 - A deep learning-based, threshold-agnostic, and subpixel-accurate spot detection method developed for spatial transcriptomics workflows.
* [Big-fish](https://github.com/fish-quant/big-fish) ⭐ 78 | 🐛 20 | 🌐 Python | 📅 2023-10-31 - Python package for the analysis of smFISH images.
* [RS-FISH](https://github.com/PreibischLab/RS-FISH) ⭐ 54 | 🐛 10 | 🌐 Java | 📅 2025-02-04 - Fiji plugin to detect FISH spots in 2D/3D images which scales to very large images.
...
* [Picasso](https://github.com/jungmannlab/picasso) ⭐ 146 | 🐛 2 | 🌐 Python | 📅 2026-08-09 - A collection of tools for painting super-resolution images.
...
* [SMAP](https://github.com/jries/SMAP) ⭐ 84 | 🐛 12 | 🌐 MATLAB | 📅 2026-08-11 - A modular super-resolution microscopy analysis platform for SMLM data.
...
* [Empanada](https://github.com/volume-em/empanada) ⭐ 3 | 🐛 7 | 🌐 Python | 📅 2023-02-25 - Panoptic segmentation algorithms for 2D and 3D electron microscopy images.
...
* [LLSpy](https://github.com/tlambert03/LLSpy) ⭐ 30 | 🐛 5 | 🌐 Python | 📅 2026-08-03 - Python library to facilitate lattice light sheet data processing.
...
* [TrackMate](https://github.com/fiji/TrackMate) ⭐ 238 | 🐛 22 | 🌐 Java | 📅 2026-08-12 - User-friendly interface that allows for performing tracking, data visualization, editing results and track analysis in a convenient way.
...
* [Ultrack](https://github.com/royerlab/ultrack) ⭐ 204 | 🐛 72 | 🌐 Python | 📅 2026-08-13 - Versatile cell tracking method for 2D, 3D, and multichannel timelapses, overcoming segmentation challenges in complex tissues.
...
* [PathML](https://github.com/Dana-Farber-AIOS/pathml) ⭐ 461 | 🐛 51 | 🌐 Python | 📅 2026-07-17 - An open-source toolkit for computational pathology and machine learning.
* [FastPathology](https://github.com/AICAN-Research/FAST-Pathology) ⭐ 145 | 🐛 26 | 🌐 C++ | 📅 2024-06-14 - Open-source software for deep learning-based digital pathology.
* [PAQUO](https://github.com/bayer-science-for-a-better-life/paquo) ⭐ 136 | 🐛 35 | 🌐 Python | 📅 2026-04-30 - A library for interacting with QuPath from Python.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,083 | 🐛 96 | 🌐 C++ | 📅 2026-08-13 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
* [ZeroCostDL4Mic](https://github.com/HenriquesLab/ZeroCostDL4Mic) ⭐ 648 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-03-29 - Google Colab to develop a free and open-source toolbox for deep-Learning in microscopy.
* [Neurite](https://github.com/adalca/neurite) ⭐ 376 | 🐛 20 | 🌐 Python | 📅 2026-08-10 - Neural networks toolbox focused on medical image analysis.
...
* [OAD](https://github.com/zeiss-microscopy/OAD) ⭐ 169 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-07-10 - Collection of tools and scripts useful to automate microscopy workflows in ZEN Blue using Python and Open Application Development tools.
* [Pycytominer](https://github.com/cytomining/pycytominer) ⭐ 144 | 🐛 43 | 🌐 Python | 📅 2026-08-13 - Data processing functions for profiling perturbations.
...
* [BoneJ](https://github.com/bonej-org/BoneJ2) ⭐ 29 | 🐛 32 | 🌐 Java | 📅 2026-06-28 - Collection of Fiji/ImageJ plug-ins for skeletal biology.
...
* [MIA](https://github.com/mianalysis/mia) ⭐ 17 | 🐛 45 | 🌐 Java | 📅 2026-08-07 - Fiji plugin which provides a modular framework for assembling image and object analysis workflows.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-08-09 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
...
* [OpenMicroscopy](https://github.com/HohlbeinLab/OpenMicroscopy) ⭐ 187 | 🐛 0 | 🌐 Python | 📅 2026-07-23 - Non-comprehensive list of projects and resources related to open microscopy.
* [Cytodata](https://github.com/cytodata/awesome-cytodata) ⭐ 94 | 🐛 5 | 📅 2023-11-15 - A curated list of awesome cytodata resources.
