...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,797 | 🐛 2,762 | 🌐 C++ | 📅 2026-09-11 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,585 | 🐛 949 | 🌐 Python | 📅 2026-09-09 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,757 | 🐛 1,250 | 🌐 Python | 📅 2026-09-07 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,624 | 🐛 656 | 🌐 C++ | 📅 2026-09-11 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,404 | 🐛 134 | 🌐 Java | 📅 2026-08-07 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,136 | 🐛 305 | 🌐 Python | 📅 2026-09-10 - Open-source software helping biologists turn images into cell measurements.
* [Fiji](https://github.com/fiji/fiji) ⭐ 1,019 | 🐛 138 | 🌐 Shell | 📅 2026-07-18 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
* [ImageJ](https://github.com/imagej/ImageJ) ⭐ 783 | 🐛 89 | 🌐 Java | 📅 2026-07-22 - Public domain software for processing and analyzing scientific images.
* [Ilastik](https://github.com/ilastik/ilastik) ⭐ 407 | 🐛 569 | 🌐 Python | 📅 2026-09-10 - Simple, user-friendly tool for interactive image classification, segmentation and analysis.
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 62 | 🌐 Python | 📅 2026-09-11 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [PYME](https://github.com/python-microscopy/python-microscopy) ⭐ 100 | 🐛 146 | 🌐 Python | 📅 2026-09-11 - Open-source application suite for light microscopy acquisition, data storage, visualization, and analysis.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,356 | 🐛 69 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
...
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 721 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 598 | 🐛 102 | 🌐 Python | 📅 2026-09-10 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [DeepCell](https://github.com/vanvalenlab/deepcell-tf) ⭐ 478 | 🐛 56 | 🌐 Python | 📅 2026-06-04 - Deep learning library for single cell analysis.
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 473 | 🐛 65 | 🌐 Python | 📅 2026-09-07 - Pipeline for processing two-photon calcium imaging data.
...
* [Classpose](https://github.com/sohmandal/classpose) ⭐ 36 | 🐛 3 | 🌐 Python | 📅 2026-07-28 - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,382 | 🐛 238 | 🌐 TypeScript | 📅 2026-09-05 - WebGL-based viewer for volumetric data.
* [CaImAn](https://github.com/flatironinstitute/CaImAn) ⭐ 736 | 🐛 100 | 🌐 Python | 📅 2026-08-02 - Computational toolbox for large scale Calcium Imaging Analysis.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 822 | 🐛 76 | 🌐 Python | 📅 2026-09-10 - Open-source image analysis software package targeted for plant phenotyping.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,085 | 🐛 104 | 🌐 C++ | 📅 2026-09-11 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [BoneJ](https://github.com/bonej-org/BoneJ2) ⭐ 30 | 🐛 32 | 🌐 Java | 📅 2026-09-11 - Collection of Fiji/ImageJ plug-ins for skeletal biology.
