...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,456 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-15 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,573 | 🐛 940 | 🌐 Python | 📅 2026-08-16 - Collection of algorithms for image processing.
...
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,581 | 🐛 660 | 🌐 C++ | 📅 2026-08-16 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
* [ImageJ2](https://github.com/imagej/imagej2) ⭐ 1,396 | 🐛 134 | 🌐 Java | 📅 2026-08-07 - A Rewrite of ImageJ for multidimensional image data, with a focus on scientific imaging.
...
* [Fiji](https://github.com/fiji/fiji) ⭐ 1,008 | 🐛 138 | 🌐 Shell | 📅 2026-07-18 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 63 | 🌐 Python | 📅 2026-08-16 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Proseg](https://github.com/dcjones/proseg) ⭐ 185 | 🐛 81 | 🌐 Rust | 📅 2026-08-10 : A cell segmentation method for in situ spatial transcriptomics.
...
* [ThermImageJ](https://github.com/gtatters/ThermImageJ) ⭐ 54 | 🐛 0 | 🌐 ImageJ Macro | 📅 2026-06-27 - ImageJ functions and macros for working with thermal image files.

## Neuroscience

* [Neuroglancer](https://github.com/google/neuroglancer/) ⭐ 1,351 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-14 - WebGL-based viewer for volumetric data.
* [CaImAn](https://github.com/flatironinstitute/CaImAn) ⭐ 730 | 🐛 101 | 🌐 Python | 📅 2026-08-02 - Computational toolbox for large scale Calcium Imaging Analysis.
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 665 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - Python package for the visualization of three dimensional neuro-anatomical data.
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 231 | 🐛 94 | 🌐 Python | 📅 2026-08-16 - Automated 3D cell detection and registration of whole-brain images.
...
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 183 | 🐛 292 | 🌐 Python | 📅 2026-08-16 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 149 | 🐛 20 | 🌐 Python | 📅 2026-08-16 - Automated 3D brain registration with support for multiple species and atlases.
* [AxonDeepSeg](https://github.com/axondeepseg/axondeepseg) ⭐ 127 | 🐛 56 | 🌐 Python | 📅 2026-08-16 - Segment axon and myelin from microscopy data using deep learning.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 60 | 🐛 12 | 🌐 Java | 📅 2026-08-16 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [SMAP](https://github.com/jries/SMAP) ⭐ 84 | 🐛 12 | 🌐 MATLAB | 📅 2026-08-15 - A modular super-resolution microscopy analysis platform for SMLM data.
...
* [Ultrack](https://github.com/royerlab/ultrack) ⭐ 206 | 🐛 72 | 🌐 Python | 📅 2026-08-13 - Versatile cell tracking method for 2D, 3D, and multichannel timelapses, overcoming segmentation challenges in complex tissues.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,082 | 🐛 97 | 🌐 C++ | 📅 2026-08-15 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [OAD](https://github.com/zeiss-microscopy/OAD) ⭐ 170 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-07-10 - Collection of tools and scripts useful to automate microscopy workflows in ZEN Blue using Python and Open Application Development tools.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-08-16 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
