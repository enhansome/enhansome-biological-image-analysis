...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,744 | 🐛 2,777 | 🌐 C++ | 📅 2026-09-07 - Open source computer vision and machine learning software library.
* [Scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,582 | 🐛 949 | 🌐 Python | 📅 2026-09-04 - Collection of algorithms for image processing.
* [Napari](https://github.com/napari/napari) ⭐ 2,757 | 🐛 1,239 | 🌐 Python | 📅 2026-09-07 - Fast, interactive, multi-dimensional image viewer for Python.
* [3D Slicer](https://github.com/Slicer/Slicer) ⭐ 2,617 | 🐛 667 | 🌐 C++ | 📅 2026-09-07 - Free, open source and multi-platform software package widely used for medical, biomedical, and related imaging research.
...
* [CellProfiler](https://github.com/CellProfiler/CellProfiler) ⭐ 1,136 | 🐛 307 | 🌐 Python | 📅 2026-09-04 - Open-source software helping biologists turn images into cell measurements.
* [Fiji](https://github.com/fiji/fiji) ⭐ 1,015 | 🐛 138 | 🌐 Shell | 📅 2026-07-18 - A "batteries-included" distribution of ImageJ — a popular, free scientific image processing application.
...
* [Cell-ACDC](https://github.com/SchmollerLab/Cell_ACDC) ⭐ 200 | 🐛 64 | 🌐 Python | 📅 2026-09-04 - A GUI-based Python framework for segmentation, tracking, cell cycle annotations and quantification of microscopy data.
...
* [Cellpose](https://github.com/MouseLand/cellpose) ⭐ 2,349 | 🐛 66 | 🌐 Python | 📅 2026-06-14 - A generalist algorithm for cell and nucleus segmentation.
* [StarDist](https://github.com/stardist/stardist) ⭐ 1,260 | 🐛 70 | 🌐 Python | 📅 2026-02-14 - Object detection with Star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net) ⭐ 744 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - A multi-branch network for nuclear instance segmentation and classification with pre-trained weights.
* [MicroSAM](https://github.com/computational-cell-analytics/micro-sam) ⭐ 719 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-09-07 - Tools for segmentation and tracking in microscopy build on top of SegmentAnything. Segment and track objects in microscopy images interactively.
* [Squidpy](https://github.com/scverse/squidpy) ⭐ 596 | 🐛 102 | 🌐 Python | 📅 2026-09-07 - Python framework that brings together tools from omics and image analysis to enable scalable description of spatial molecular data, such as transcriptome or multivariate proteins.
...
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 472 | 🐛 64 | 🌐 Python | 📅 2026-08-23 - Pipeline for processing two-photon calcium imaging data.
...
* [CellSAM](https://github.com/vanvalenlab/cellSAM) ⭐ 215 | 🐛 50 | 🌐 Python | 📅 2026-06-04 - A foundation model for cell segmentation trained on a diverse range of cells and data types.
...
* [PartSeg](https://github.com/4DNucleome/PartSeg) ⭐ 37 | 🐛 23 | 🌐 Python | 📅 2026-09-07 - A GUI and a library for segmentation algorithms.
* [Classpose](https://github.com/sohmandal/classpose) ⭐ 35 | 🐛 3 | 🌐 Python | 📅 2026-07-28 - A foundation model-driven whole slide image-scale cell phenotyping method with QuPath integration.
...
* [SyMBac](https://github.com/georgeoshardo/SyMBac) ⭐ 23 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2026-09-01 - Accurate segmentation of bacterial microscope images using synthetically generated image data.
...
* [Brainrender](https://github.com/brainglobe/brainrender) ⭐ 669 | 🐛 10 | 🌐 Python | 📅 2026-09-07 - Python package for the visualization of three dimensional neuro-anatomical data.
* [Cellfinder](https://github.com/brainglobe/cellfinder) ⭐ 231 | 🐛 95 | 🌐 Python | 📅 2026-09-07 - Automated 3D cell detection and registration of whole-brain images.
* [PyTorch Connectomics](https://github.com/zudi-lin/pytorch_connectomics) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-09-04 - Deep learning framework for automatic and semi-automatic annotation of connectomics datasets, powered by PyTorch.
* [BG-atlasAPI](https://github.com/brainglobe/bg-atlasapi) ⭐ 186 | 🐛 301 | 🌐 Python | 📅 2026-09-07 - A lightweight Python module to interact with atlases for systems neuroscience.
...
* [Brainreg](https://github.com/brainglobe/brainreg) ⭐ 150 | 🐛 20 | 🌐 Python | 📅 2026-09-07 - Automated 3D brain registration with support for multiple species and atlases.
...
* [SNT](https://github.com/morphonets/SNT/) ⭐ 61 | 🐛 12 | 🌐 Java | 📅 2026-09-07 - ImageJ framework for semi-automated tracing and analysis of neurons.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 821 | 🐛 124 | 🌐 Python | 📅 2026-09-07 - Open-source image analysis software package targeted for plant phenotyping.
* [PlantSeg](https://github.com/hci-unihd/plant-seg) ⭐ 130 | 🐛 31 | 🌐 Python | 📅 2026-09-07 - Tool for cell instance aware segmentation in densely packed 3D volumetric images.
...
* [Picasso](https://github.com/jungmannlab/picasso) ⭐ 149 | 🐛 1 | 🌐 Python | 📅 2026-09-04 - A collection of tools for painting super-resolution images.
...
* [TrackMate](https://github.com/fiji/TrackMate) ⭐ 240 | 🐛 20 | 🌐 Java | 📅 2026-08-28 - User-friendly interface that allows for performing tracking, data visualization, editing results and track analysis in a convenient way.
...
* [SimpleITK](https://github.com/SimpleITK/SimpleITK) ⭐ 1,084 | 🐛 102 | 🌐 C++ | 📅 2026-09-06 - Open-source multi-dimensional image analysis in Python, R, Java, C#, Lua, Ruby, TCL and C++.
...
* [Pycytominer](https://github.com/cytomining/pycytominer) ⭐ 144 | 🐛 44 | 🌐 Python | 📅 2026-09-04 - Data processing functions for profiling perturbations.
...
* [BoneJ](https://github.com/bonej-org/BoneJ2) ⭐ 30 | 🐛 32 | 🌐 Java | 📅 2026-06-28 - Collection of Fiji/ImageJ plug-ins for skeletal biology.
...
* [DetecDiv](https://github.com/gcharvin/DetecDiv) ⭐ 9 | 🐛 2 | 🌐 MATLAB | 📅 2026-09-07 - Comprehensive set of tools to analyze time microscopy images using deep learning methods.
